  ...
  <div>
    ...
    <nav class="navbar navbar-toggleable-md navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <router-link :to="{name:'contactLink'}" tag="li" class="nav-item">
          <a class="nav-link">contact us</a>
        </router-link>
        <router-link :to="{name:'orderingGuideLink'}" tag="li" class="nav-item">
          <a class="nav-link">ordering guide</a>
        </router-link>
        <router-link :to="{name:'deliveryLink'}" tag="li" class="nav-item">
